...
public class formFindByClass implements ActionListener {
    ...
    public void createUserInterface(){
        ...
        ArrayList<String> plist = ms.getIdClass();
    ...
    private void showResults(){
        ...
        try {
            ...
            ArrayList<ArrayList<String>> plist = ms.displayStudents(classID);
    ...
    public static void main(String[] args){
        formFindByClass f = new formFindByClass();
