...
int main()
{
	...
	// VIET CODE CUA BAN O DAY
	// ...
	if(queueIsEmpty(q) == true) cout << "Hang doi rong" << endl;
	else cout << "Hang doi co phan tu" << endl;
...
void check(Queue & q , int x)
{
	...
	if(counter != 0) cout << "Co phan tu trong hang doi" << endl;
	else cout << "Khong co phan tu can tim kiem" << endl;
}
