...
int main()
{
    ...
    int pos1 = BinarySearch(vec2, y);
    if(pos1 == -1) cout<<"Khong tim thay phan tu can tim kiem";
    else cout<<"Tim thay phan tu can tim kiem tai vi tri: "<<pos1;

    // 7
    cout<<"\n7.Xoa cac phan tu nam o cac vi tri tu pos1 den pos2 tren vector 2";
    int pos2, pos3;
    cout<<"\nNhap pos 1: "; cin>>pos2;
    cout<<"Nhap pos 2: "; cin>>pos3;
    DeleteP1toP2(vec2, pos2, pos3);
    cout<<"In lai cac phan tu sau khi xoa:";
    output(vec2);
...
int BinarySearch(Vector & vec, int x) {
